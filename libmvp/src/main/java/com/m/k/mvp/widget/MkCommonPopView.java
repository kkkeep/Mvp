...
public class MkCommonPopView extends PopupWindow {
    ...
    public MkCommonPopView(Context context, int width, int height) {
        super(context);
    ...
    public MkCommonPopView(Context context) {
